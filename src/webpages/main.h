...
<div class="row gx-0 mb-2">
    <div class="col">
        <div class="bg-light">Humididy Analog Value:</div>
    </div>
    <div class="col">
...
<script>
    ...
    function onMessage(event) {
        ...
        document.getElementById("packV").innerHTML = data.Pack.wet_val == null ? 'No connection or Sleeping' : data.Pack.wet_val + ' \u2030 ';
